...
public class RetailCollisionGeometry extends CollisionGeometry {
  private static final Logger LOGGER = LogManager.getFormatterLogger(RetailCollisionGeometry.class);
...
//  public TmdWithId tmdPtr_1c;
  ...
  public RetailCollisionGeometry(final SMap smap) {
    this.smap = smap;
  }
