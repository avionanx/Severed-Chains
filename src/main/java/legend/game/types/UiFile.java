...
public record UiFile(UiType uiElements_0000, UiType itemIcons_c6a4, UiType portraits_cfac, UiType _d2d8) {
  public static UiFile fromFile(final FileData data) {
    ...
    portraits_cfac.entries_08 = Arrays.copyOf(portraits_cfac.entries_08, portraits_cfac.entries_08.length + 2);
    portraits_cfac.entries_08[9] = portraits_cfac.entries_08[6];
    portraits_cfac.entries_08[10] = portraits_cfac.entries_08[0];
